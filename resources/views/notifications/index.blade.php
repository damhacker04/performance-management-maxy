...
<div class="page">
    ...
    <div style="display:flex;align-items:center;gap:8px;">
        <a href="{{ route('dashboard') }}" class="icon-btn" style="margin-left:-8px;">
    ...
    @else
        ...
        @foreach($grouped as $date => $notifs)
            ...
            <!-- Date header -->
            <div style="display:flex;align-items:center;gap:8px;color:var(--fg-4);
                       ...
                       style="display:flex;align-items:flex-start;gap:12px;
                        ...
                        <div style="flex:1;min-width:0;">
                            <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;margin-bottom:3px;">
                                ...
                                <span style="font-size:10px;color:var(--fg-4);flex-shrink:0;margin-top:2px;">
